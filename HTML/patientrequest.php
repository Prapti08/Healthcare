    ...
    <section class="container-fluid bg">
        <section class="row justify-content-center">
            <section class="col-12 col-sm-6 col-md-3">
                <form class="form-container"action="patientrequest.php"  method="post" enctype="multipart/form-data">
                 ...
                 <div class="row">
                  ...
                  <input type="text"name="patientid" class="form-control" >
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="2" cols="25" name="problem" required></textarea>
                      </div>
                     
                      
                    
                    <button type="submit" name="submit" class="btn btn-primary btn-block">Request for appointment</button>
                  </form>
            </section>
        </section>
    </section>
...
<div class="card" style="width: 20rem;">
  ...
  <ul class="list-group list-group-flush">
    <li class="list-group-item"> Your ID- <?php echo $row['id'];?></li>
    </ul>
    </div>
<?php
}

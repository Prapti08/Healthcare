    ...
    <section class="container-fluid bg">
        <section class="row justify-content-center">
            <section class="col-12 col-sm-6 col-md-3">
                <form class="form-container"action="changeinfo.php"  method="post" enctype="multipart/form-data">
              ...
              <input type="text" name="weight" class="form-control">
                    ...
                    <div class="form-group">
                        <label>Any allergies or previous illness</label>
...
$sql="UPDATE patientdetails SET height = '$height' ,weight= '$weight',allergies= '$allergies'  WHERE email = '$email'";
